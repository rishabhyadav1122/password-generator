   ...
   <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800'>
    ...
    <div className='flex text-sm gap-x-2' >
      <div  className='flex items-center gap-x-1 ' >
        <input className='slider' type="range"  min={6} max = {100}  value={length}  
        onChange={(e) => {
...
<input type="checkbox" className='slider cursor-pointer'  defaultChecked= {numberAllowed} id='numberInput' 
onChange={() => {
...
<label htmlFor="numberInput">Numbers</label>
      ...
      <div className='flex item-center gap-x-1'>
<input className='slider' type="checkbox" defaultChecked= {charAllowed} id='charInput' 
onChange={() => {
  setCharAllowed((prev) => 
    !prev
  );
